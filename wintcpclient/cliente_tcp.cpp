...
//
// Programa-cliente para simular o Sistema de Planejamento de Operações - 2023/1
...
// 20 * 100ms = 2 segundos.
//
// A tecla "s", quando digitada, força o envio de uma mensagem de parâmetros
...
//
// ATENCÃO: APESAR DESTE PROGRAMA TER SIDO TESTADO PELO PROFESSOR, NAO HÁ GARANTIAS DE
// QUE ESTEJA LIVRE DE ERROS. SE VOCE ENCONTRAR ALGUM ERRO NO PROGRAMA, COMUNIQUE O
// MESMO AO PROFESSOR, INDICANDO TAMBÉM, SEMPRE QUE POSSÍVEL, SUA CORREÇÃO PROPOSTA.
//
   ...
   while (TRUE) {
     ...
     for (;;) {
	   ...
	   if (flagreq == 1) {
		 ...
		 // Sim: envia msg de parâmetros de controle ao CLP
		 if (vez == 0)
